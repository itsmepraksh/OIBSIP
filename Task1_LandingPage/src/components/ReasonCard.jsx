...
const ReasonCard = ({text}) => {
  return (
    <div className="reason bg-white shrink-[0] w-[80%] aspect-1/1  px-[2rem] md:px-[4rem] lg:px-[6rem] xl:px-[9rem] 2xl:px-[12rem] py-[2rem] md:py-[3rem] ">
      ...
      <Button className="w-[55%] my-4   xl:py-3 xl:px-4  " text="Details" />
    </div>
  );
};
