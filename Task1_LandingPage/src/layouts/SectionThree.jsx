...
const SectionThree = () => {
  return (
    <>
      <section className="secThree   flex flex-col justify-center items-center  px-[2rem] md:px-[4rem] lg:px-[6rem] xl:px-[9rem]  py-[1rem] md:py-[3rem] bg-white m-3 md:m-6 rounded">
        ...
        <div className="founder-mssg my-15 relative">
                <h1 className="text-2xl md:text-3xl lg:text-4xl font-medium text-[#133C2A] text-center py-5 md:py-7">
           "Here's a Message from our Founder"</h1>
                
                <img className="w-[80%] lg:w-[70%]   2xl:w-[80%] md:aspect-[16/9]  md:object-cover rounded absolute -translate-x-1/2 left-1/2" src="https://images.unsplash.com/photo-1714079761488-e0c9b9ac4138?q=80&w=1171&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
            </div>
      </section>
    </>
  );
